...
public class Map {
     ...
     * Singleton getter.
     *
     * @return Returns the instance of the Map Singleton.
     */
    ...
    /**
     * First initialization of the Map object.
     ...
     * @return The instantiated reference to the new Map Singleton object
     * @throws OperationNotSupportedException If the Map Singleton has been already initialized.
     */

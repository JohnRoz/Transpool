...
public class TripOffer {
    ...
    /*public TripOffer(String offeringUserName, int passengersQuota, Set<Road> roadsInPath, double pricePreKm, TripTiming timing) {
    ...
    private void InitStationsInTrip() {
        ...
        for (Road road : roadsInTrip) {
            stationsInTrip.add(Map.getStationByName(road.getSourceStationName()));
            stationsInTrip.add(Map.getStationByName(road.getDestStationName()));
        }
    }*/
    ...
    public TripOffer(String offeringUserName, int passengersQuota, SortedSet<Station> stations, double pricePreKm, TripTiming timing) {
        ...
        this.roadsInTrip = Map.getRoadsBetweenStations(stations);
    }
